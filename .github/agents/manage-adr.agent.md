...
- INDEX の基本 Status だけで適用範囲を判断せず、本文の Status 節を確認する。後続 ADR による置換や一部 amend は参照先をたどり、変更範囲と残る有効な判断を確認する。必要なら C または D を提案するが、レビュー中には実行しない。
