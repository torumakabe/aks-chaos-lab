...
**Prompt file**: https://github.com/github/gh-aw/blob/v0.50.2/.github/aw/test-coverage.md
...
- Always reference the instructions file at https://github.com/github/gh-aw/blob/v0.50.2/.github/aw/github-agentic-workflows.md for complete documentation
