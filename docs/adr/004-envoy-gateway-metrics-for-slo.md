...
- **参照**: [AKS Istio Gateway API](https://learn.microsoft.com/azure/aks/istio-gateway-api)、`k8s/apps/chaos-app/gateway-options-configmap.yaml`、`infra/modules/prometheus/recording-rules.bicep`、`infra/modules/prometheus/alert-rules.bicep`
