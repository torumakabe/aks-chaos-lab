...
| 012 | [Azure Functions direct probe を Azure Monitor SLI の正本にする](012-functions-direct-external-sli-probe.md) | Accepted (Latency 部分は ADR-013 で amend) | 2026-05-20 |
| 013 | [Latency SLI を histogram bucket + `EQ` filter 方式に変更する](013-histogram-bucket-latency-sli.md) | Accepted | 2026-05-21 |
